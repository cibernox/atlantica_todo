...
struct TodoApp: View {
    @State private var todos: [Todo] = [
        Todo(title: "Complete project", description: "Finish the SwiftUI implementation", image: "https://picsum.photos/200", completed: false),
        Todo(title: "Review code", description: "Go through the changes", image: nil, completed: true),
        Todo(title: "Update documentation", description: nil, image: "https://picsum.photos/201", completed: false)
    ]

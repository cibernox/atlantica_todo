defmodule AtlanticaTodoWeb.CoreComponents.SwiftUI do
  @moduledoc """
  ...
  of the `AtlanticaTodoWeb.CoreComponents` functions you should expect identical functionality for similarly named
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AtlanticaTodoWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AtlanticaTodoWeb.Gettext, "errors", msg, opts)
    end
  end

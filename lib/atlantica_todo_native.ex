defmodule AtlanticaTodoNative do
  @moduledoc """
  ...
  import AtlanticaTodoWeb, only: [verified_routes: 0]
  ...
  def live_view() do
    quote do
      use LiveViewNative.LiveView,
        ...
        layouts: [
          swiftui: {AtlanticaTodoWeb.Layouts.SwiftUI, :app}
        ],
  ...
  defp helpers(format) do
    gettext_quoted = quote do
      import AtlanticaTodoWeb.Gettext
    end
    ...
    core_component_module = Module.concat([AtlanticaTodoWeb, CoreComponents, plugin.module_suffix])
